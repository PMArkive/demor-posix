...
class Demor(wx.Frame):
    ...
    def __init__(self, parent):
        ...
        self.VersionText = wx.StaticText(self, wx.ID_ANY, "Demor v1.1.1 by deluxghost", wx.DefaultPosition, wx.DefaultSize, 0)
        self.VersionText.Wrap(-1)
        ButtonSizer.Add(self.VersionText, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL, 5)
